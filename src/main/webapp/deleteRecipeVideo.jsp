...
<style>
        *{
        ...
        .login-holder{
            height: 1150px;width: 400px;background-color: rgb(0, 0, 0);margin: auto;margin-top: 90px;border-radius: 20px;
        }
        .login-holder-div{
            ...
            <div class="login-holder-input">            
               <form action="servlet" method="post">
                  ...
                  <div class="login-holder-button-holder">
                      <button class="login-holder-button" type="submit" name="operation" id="delete-recipe-video" value="delete-recipe-video">Delete</button>
                      <button class="login-holder-button" type="submit" name="operation" id="update-recipe-video" value="update-recipe-video">Update</button>
                  </div>
               </form>
            </div>
       </div>
