...
<style>
        *{
        ...
        .login-holder{
            height: 640px;width: 400px;background-color: rgb(0, 0, 0);margin: auto;margin-top: 90px;border-radius: 20px;
        }
        .login-holder-div{
        ...
        <div class="login-holder-div">
            ...
            <div class="login-holder-input">
               ...
               <form action="servlet" method="post">
                  ...
                  <p>UserLogo</p>
                  <br>
                  <input class="login-holder-input-1" type="text" name="userlogo" id="userlogo" value="<%=rm.getUserlogo() %>">
                  <br>
                  <br>
                  
                  
                  <div class="login-holder-button-holder">
                      <input class="login-holder-button" type="submit" name="operation" id="updateUser" value="updateUser">
                  </div>
               </form>
            </div>
       </div>
